...
proc create_root_design { parentCell } {
  ...
  # Create instance: myip_adder_0, and set properties
  set myip_adder_0 [ create_bd_cell -type ip -vlnv user.org:user:myip_adder:1.0 myip_adder_0 ]
  ...
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M01_AXI [get_bd_intf_pins microblaze_0_axi_periph/M01_AXI] [get_bd_intf_pins myip_adder_0/S00_AXI]
  ...
  connect_bd_net -net rst_mig_7series_0_83M_peripheral_aresetn [get_bd_pins axi_smc/aresetn] [get_bd_pins axi_uartlite_0/s_axi_aresetn] [get_bd_pins microblaze_0_axi_periph/ARESETN] [get_bd_pins microblaze_0_axi_periph/M00_ARESETN] [get_bd_pins microblaze_0_axi_periph/M01_ARESETN] [get_bd_pins microblaze_0_axi_periph/S00_ARESETN] [get_bd_pins mig_7series_0/aresetn] [get_bd_pins myip_adder_0/s00_axi_aresetn] [get_bd_pins rst_mig_7series_0_83M/peripheral_aresetn]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x44A00000 [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs myip_adder_0/S00_AXI/S00_AXI_reg] SEG_myip_adder_0_S00_AXI_reg
